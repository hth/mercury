...
public class AutoGenerateDataRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        log.info("Clean database & start populating data every {} seconds profile={}", dataGenerateDurationInSeconds, environment.getActiveProfiles());

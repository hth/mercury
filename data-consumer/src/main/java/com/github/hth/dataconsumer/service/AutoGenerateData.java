...
public class AutoGenerateData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        log.info("Populating data every {} seconds", dataGenerateDurationInSeconds);
        Mono<Void> voidMono = creditTransactionRepository.deleteAll();
        Flux<CreditTransactionEntity> creditTransactionEntityFlux = Flux.interval(Duration.ofSeconds(dataGenerateDurationInSeconds))
